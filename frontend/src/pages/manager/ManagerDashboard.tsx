...
export default function ManagerDashboard() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      setError(null)
      try {
        const myBranchResult = await getMyBranch().catch(() => null)
        const dashboardStats = await getManagerDashboardStats().catch(() => null)
  ...
  const subtitle = myBranch
    ? `Real-time performance tracking for ${myBranch.name}.`
    : 'Welcome! No branch has been assigned to your account yet.'
      ...
      <div className="mgr-stats-grid">
        <div className="mgr-stat-card">
          <div className="mgr-stat-top">
            ...
            <div className="mgr-stat-trend">
              <svg width="14" height="8" viewBox="0 0 14 8" fill="#00FFC2" aria-hidden><path d="M0.93 8L0 7.07L4.93 2.1L7.6 4.77L11.07 1.33H9.33V0H13.33V4H12V2.27L7.6 6.67L4.93 4L0.93 8" /></svg>
              +12%
            </div>
          </div>
          <div className="mgr-stat-label">Total Services</div>
        ...
        <div className="mgr-stat-card">
          <div className="mgr-stat-top">
            ...
            <div className="mgr-stat-trend">
              <span className="mgr-status-dot" style={{ background: myBranch?.isActive ? '#00FFC2' : '#ff4b4b' }} />
              {myBranch?.isActive ? 'Active' : 'Closed'}
            </div>
          </div>
          <div className="mgr-stat-label">My Branch</div>
        ...
        <div className="mgr-stat-card">
          ...
          <div className="mgr-stat-label">Branch Revenue</div>
        ...
        <div className="mgr-stat-card">
          <div className="mgr-stat-top">
            ...
            <div className="mgr-stat-trend mgr-stat-trend--muted">Current</div>
          </div>
          <div className="mgr-stat-label">Active Orders</div>
      ...
      <div className="mgr-main-grid">
        <div className="mgr-left-col">
          ...
          <div className="mgr-panel">
            <div className="mgr-panel-header">
              ...
              <Link to="/manager/slots" className="mgr-link-btn">View All</Link>
            </div>
                  ...
                  bookings.map((booking) => {
                    ...
                    return (
                      <tr key={booking.bookingId}>
                        ...
                        <td>{booking.serviceSummary || 'No Service'}</td>
        ...
        <div className="mgr-right-col">
          <div className="mgr-panel mgr-branch-info">
            ...
            {myBranch ? (
              <>
                <div className="mgr-field-label">Branch Name</div>
                <div className="mgr-field-value mgr-field-value--lg">{myBranch.name}</div>

                <div className="mgr-field-label">Address</div>
                ...
                {myBranch.phone && (
                  <>
                    <div className="mgr-field-label">Phone</div>
                ...
                <div className="mgr-branch-status-row">
                  ...
                  <span className={`mgr-status-badge ${myBranch.isActive ? 'mgr-status-badge--open' : 'mgr-status-badge--closed'}`}>
                    {myBranch.isActive ? 'Open' : 'Closed'}
                  </span>
                </div>
              </>
            ) : (
              <p className="mgr-field-value">No branch assigned to your account yet.</p>
            )}
          </div>
          ...
          <div className="mgr-panel mgr-quick-actions">
            ...
            <div className="mgr-quick-actions-list">
              ...
              <button type="button" className="mgr-quick-action-btn">
          ...
          <div className="mgr-panel mgr-pro-tip">
            ...
            <div className="mgr-pro-tip-content">
              <div className="mgr-pro-tip-label">Pro Tip</div>
              <div className="mgr-pro-tip-text">
                Evening slots are 95% full.<br />
                Consider opening an extra bay.
              </div>
            </div>
          </div>
        </div>
