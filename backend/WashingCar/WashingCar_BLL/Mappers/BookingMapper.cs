...
public static class BookingMapper
{
    ...
    public static BookingDto ToDto(this Booking b)
    {
        ...
        return new()
        {
            ...
            ServiceSubtotal = b.BookingSubtotal - b.VehicleSurchargeAmount,
            VehicleConditionAtBooking = ((VehicleCondition)b.VehicleConditionAtBooking).ToString(),
            VehicleSurchargeRate = b.VehicleSurchargeRate,
            VehicleSurchargeAmount = b.VehicleSurchargeAmount,
